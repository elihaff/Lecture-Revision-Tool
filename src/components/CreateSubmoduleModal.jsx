...
export function CreateSubmoduleModal({ onClose, onCreate }) {
    ...
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center p-4 z-50">
      <div className="bg-surface rounded-2xl w-full max-w-md border border-divider shadow-xl">
        ...
        <div className="flex items-center justify-between p-6 border-b border-divider">
          <h2 className="text-xl font-semibold text-primary">Add Submodule</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <p className="mt-1.5 text-xs text-secondary">
              Group related lectures under this submodule
            </p>
          </div>
